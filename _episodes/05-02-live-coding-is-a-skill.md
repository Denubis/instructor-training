...
>> [discussed earlier]({{ page.root }}{% link _episodes/04-01-memory-cognitive-load.md %}#why-guided-practice-is-important).
>> This is why it is
...
[we learned earlier]({{ page.root }}{% link _episodes/02-04-mindset.md %}#errors-are-essential-to-learning) to make sure this feedback is useful to learners.
...
9. **Embrace mistakes.** No matter how well prepared you are, you will make mistakes. This is OK! Use these opportunities to do [error framing]({{ page.root }}{% link _episodes/02-04-mindset.md %}#errors-are-essential-to-learning) and to help your learners learn the art of troubleshooting.
